...
# Advanced regression casestudy - House price prediction project
This case study is to give an idea of applying concepts of advanced regression to build Machine learning models in a real business scenario as part of EPGP course
...
## Introduction
Concepts learnt in Machine Leaning 2.0 are used to solve the problem statement with Python 3.0.
